                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                          ...
                          <?php
                            ...
                            $query = "SELECT projects.proj_id, projects.proj_name, user.firstname, projects.proj_progress from projects inner join user on projects.proj_id = user.proj_id";
                            $data = $conn -> query($query);
                            $data->setFetchMode(PDO::FETCH_ASSOC);
                            foreach ($data as $row) {
                              echo '<tr>
                              <td class="col-md-1">' . $row["proj_id"] . '</td>
                              <td class="col-md-2">' . $row["proj_name"] . '</td>
                              <td class="col-md-2">' . $row["firstname"] . '</td>
                              <td class="project_progress col-md-3">
                                <div class="progress progress_sm">
                                  <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="'. $row["proj_progress"]. '"></div>
                                </div>
                                <small>'. $row["proj_progress"] . ' Complete</small>
                              </td>
                              <td>
